...
#ifndef MOYENNE_3_STATIONS2_H_INCLUDED
#define MOYENNE_3_STATIONS2_H_INCLUDED
...
namespace HYDROTEL
{
	...
	class MOYENNE_3_STATIONS2 : public INTERPOLATION_DONNEES
	{
	public:
		MOYENNE_3_STATIONS2(SIM_HYD& sim_hyd);
		virtual ~MOYENNE_3_STATIONS2();
		...
		void CalculePonderationTroncon(STATIONS& stations, TRONCONS& troncon, MATRICE<double>& ponderation, std::string sOrigin);
