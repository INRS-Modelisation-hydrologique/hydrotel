...
#ifndef STATION_HYDRO_H_INCLUDED
#define STATION_HYDRO_H_INCLUDED
...
namespace HYDROTEL
{
	...
	class STATION_HYDRO : public STATION
	{
	public:
		STATION_HYDRO(const std::string& nom_fichier);
		virtual ~STATION_HYDRO();
