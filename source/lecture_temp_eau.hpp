...
#ifndef LECTURE_TEMP_EAU_H_INCLUDED
#define LECTURE_TEMP_EAU_H_INCLUDED
...
namespace HYDROTEL
{
	...
	class LECTURE_TEMP_EAU : public TEMP_EAU
	{
	public:
		LECTURE_TEMP_EAU(SIM_HYD& sim_hyd);
		virtual ~LECTURE_TEMP_EAU();
