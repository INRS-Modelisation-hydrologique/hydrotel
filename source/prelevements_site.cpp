...
namespace HYDROTEL
{
 ...
 //   }
    ...
    {
        //multi: "LAT(d);LONG(d);ID TRONCON;ID UHRH;# OCCSOL;NOM OCCSOL;SOURCE;CRITERE;COEF_CONSO";
        std::string str = "#SITE;#SITE GPE;#SITE PRELEVEMENT;" + printLegendMulti() + ";TYPE CHEPTEL;NOMBRE T TE;CONSOMMATION m^3/an;CONSOMMATION TOTAL m^3/an;NOM DU LIEU;NOM DE LEXPLOITANT;MUNICIPALITE";
        return str;
    }
