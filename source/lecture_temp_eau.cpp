...
namespace HYDROTEL
{
	...
	LECTURE_TEMP_EAU::LECTURE_TEMP_EAU(SIM_HYD& sim_hyd)
		: TEMP_EAU(sim_hyd, "LECTURE TEMP EAU")
	{
	}

	LECTURE_TEMP_EAU::~LECTURE_TEMP_EAU()
	{
	}

	void LECTURE_TEMP_EAU::Initialise()
	{
		//string ligne;
	...
	void LECTURE_TEMP_EAU::ChangeNbParams(const ZONES& /*zones*/)
	{
	}


	void LECTURE_TEMP_EAU::LectureParametres()
	{
	...
	void LECTURE_TEMP_EAU::SauvegardeParametres()
	{
